...
@SourceType(value = "ActOnARP", label = "ActOn",uiConfig = "acton-layout.json")
public class ActOnConf extends AbstractArpConf<ActOnConf> {
  private static final String ARP_FILENAME = "arp/implementation/acton-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.acton.ActOnDriver";
